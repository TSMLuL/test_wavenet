...
class WaveNetModel(nn.Module):
    ...
    def generate_fast(self,
        ...
        generated = np.array([])
        regularizer = torch.pow(torch.LongTensor(torch.arange(self.classes)).float() - self.classes / 2., 2) # torch.pow(Variable(torch.arange(self.classes)) - self.classes / 2., 2)
        ...
        for i in range(num_samples):
            ...
            print('gen step: of sample {} out of {} samples completed'.format(str(i), str(num_samples)))
